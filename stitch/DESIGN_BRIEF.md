...
- SignalSprint Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called SignalSprint Lite. It should be a full-viewport timing arcade game where the player switches relay lanes at the correct moment to keep energy pulses moving through a grid, with score, combo multiplier, level progress, miss feedback, pause/resume, restart, settings, keyboar…
...
- Gameplay - SignalSprint Lite
- Game Settings - SignalSprint Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - SignalSprint Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - SignalSprint Lite
